 ...
 */
class AggregatorException extends Error {
...
(function (ExceptionType) {
    ExceptionType["API_KEY_ERROR"] = "api_key_error";
    ExceptionType["API_CHAIN_ERROR"] = "api_chain_error";
    ExceptionType["REQUEST_ERROR"] = "request_error";
    ExceptionType["RESPONSE_DATA_EMPTY"] = "response_data_empty";
    ExceptionType["NFT_SCAN_DATA_EMPTY"] = "nftgo_data_empty";
    ExceptionType["PARAM_ERROR"] = "param_error";
...
class AggregatorV1 {
    ...
    getListingsOfSingleNFT(contract, tokenId) {
    ...
    getFilteredNFTs(contract, params) {
        if (isInvalidParam(contract)) {
            throw AggregatorException.missingParamError('collection contract');
        }
    ...
    post(path, params) {
        return this.client.post(this.url + path, params, this.headers);
    }
    get(path, query) {
        return this.client.get(this.url + path, query, this.headers);
    }
}
